...
export const HTTP_PROXY_SERVICE_UUID = '1823';

// Characteristic UUIDs (short form)
export const URI_CHARACTERISTIC_UUID = '2AB6';
export const HTTP_HEADERS_CHARACTERISTIC_UUID = '2AB7';
export const HTTP_STATUS_CODE_CHARACTERISTIC_UUID = '2AB8';
export const HTTP_ENTITY_BODY_CHARACTERISTIC_UUID = '2AB9';
export const HTTP_CONTROL_POINT_CHARACTERISTIC_UUID = '2ABA';
export const HTTPS_SECURITY_CHARACTERISTIC_UUID = '2ABB';
